...
### Shopping / gather list (cleanup)

**PPE (don't skip with droppings)**
- [ ] N95 or P100 respirator (dust + dried droppings)
- [ ] Nitrile gloves (box)
- [ ] Safety glasses
- [ ] Disposable coveralls or clothes you can wash hot immediately
- [ ] Closed-toe shoes you can rinse

**Wet-clean / disinfect**
- [ ] Disinfectant that lists animal waste / viruses (bleach 1:10 in a spray bottle, or a labeled disinfectant spray)
- [ ] All-purpose cleaner or TSP substitute for grimy OSB / T1-11
- [ ] Spray bottles
- [ ] Paper towels + rags you can throw away
- [ ] Stiff nylon brush + sponge mop / deck brush
- [ ] Bucket

**Dust + debris**
- [ ] Contractor bags (3 mil)
- [ ] Shop vac + extra bags/filters (HEPA if you have it; otherwise a decent shop-vac filter)
